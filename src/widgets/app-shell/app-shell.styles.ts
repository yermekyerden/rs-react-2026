export const APP_SHELL_CLASS_NAMES = {
  body: 'min-h-screen bg-slate-950 text-slate-100 antialiased selection:bg-emerald-300/30',
  shell:
  ...
  brand:
    'justify-self-start rounded-full px-3 py-2 text-sm font-black uppercase tracking-[0.18em] text-emerald-300 transition hover:bg-emerald-300/10 focus:outline-none focus:ring-2 focus:ring-emerald-300',
  navigation:
